...
<div class="container">
    ...
    <h2 class="mt-4">{{ __('Nearby Places') }}</h2>
        ...
        <ul class="list-group">
            @foreach ($viewData['places'] as $place)
                <li class="list-group-item">
                    ...
                    <a href="https://www.google.com/maps/search/?api=1&query={{ urlencode($place['name']) }}&query_place_id={{ $place['place_id'] }}" target="_blank" class="btn btn-primary btn-sm">{{ __('PetFriendly.view_on_map') }}</a>
                </li>
            @endforeach
        </ul>
    @else
